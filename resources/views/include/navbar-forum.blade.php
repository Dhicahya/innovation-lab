  ...
  <header id="header" class="fixed-top d-flex align-items-center shadow-sm">
      <div class="container d-flex align-items-center justify-content-between">
          ...
          <nav id="navbar" class="navbar">
              <ul>
                  <li>
                      <form action="{{ route('forum.search') }}" method="GET" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                      ...
                      @auth
                          <a class="nav-link dropdown-toggle py-0" href="#" id="userDropdown" role="button"
                              ...
                              <span
                                  ...
                                  <img class="img-profile rounded-circle" src="/storage/{{auth()->user()->image_path}}" style="height: 35px; width: 35px"> 
                                  @else
